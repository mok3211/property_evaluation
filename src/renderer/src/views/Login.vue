         ...
         <el-form :mode="incomeMethodFormData">
                ...
                <el-form-item label-width="100px" label="验证码:" prop="code">
                    <div class="itemInput">
                        <el-input
                          style="60%"
                          v-mode="incomeMethodFormData.code"
                          placeholder="请输入验证码"
                        ></el-input>
                 ...
                 <div class="btn-confirm">
                    <el-button type="primary" style="width:100%;height:40px;margin-top:20px" @click="saveIncomeMethodData">注册</el-button>
                  </div>
         </el-form>
        </div>
